...
{{- define "redis-cluster.selectRedisAll" -}}
app: redis
{{- end -}}

{{- define "redis-cluster.selectMasterOnly" -}}
app: redis
role: master
{{- end -}}

{{- define "redis-cluster.selectReplicaOnly" -}}
app: redis
role: replica
{{- end -}}

{{- define "redis-cluster.selectSentinelOnly" -}}
app: redis
role: sentinel
{{- end -}}

{{- define "redis-cluster.fileConfigMap" -}}
{{ .Chart.Name }}-files-cm
{{- end -}}

{{- define "redis-cluster.headlessService" -}}
{{ .Chart.Name }}-headless-svc
{{- end -}}

{{- define "redis-cluster.replicaCount" -}}
{{- mul .Values.masters .Values.replicaForEachMaster -}}
{{- end -}}